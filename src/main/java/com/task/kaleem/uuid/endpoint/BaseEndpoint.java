...
import com.task.kaleem.uuid.exception.Error;
...
public abstract class BaseEndpoint {
  ...
  /**
   * Exception handler for validation errors caused by method parameters @RequesParam, @PathVariable, @RequestHeader annotated
   * with javax.validation constraints.
   */
  @ExceptionHandler
